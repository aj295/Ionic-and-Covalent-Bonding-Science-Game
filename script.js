...
let level1Ini = function(thisLevel) {
    ...
    let element = new Element(thisLevel, -1, 0.9, electron, window_width - 100, window_height - 1000, "elemAndElectron")
    element.draw()

    let element2 = new Element(thisLevel, 2, 0.5, positive, 20, window_height - characterHeight - 1000, "elemAndElectron")
    element2.draw()

    // let element3 = new Element(thisLevel, 2, 0.4, positive, window_width - 400, window_height - characterHeight - 1000, "elemAndElectron")
    // element3.draw()
